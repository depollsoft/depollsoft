...
public class TagDetailActivity extends TabActivity
{
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      UiBinder.registerBinding(this, new Binding(
            new ThreadSwitchProperty<Object>(new ReflectedProperty(this,
                  "Title"), this), new ReflectedProperty(this, "Tag.Title"))
            .bind(this));
   ...
   public boolean onMenuItemSelected(int featureId, MenuItem item)
   {
      ...
      else if (item.getItemId() == R.id.smsMenuItem)
      {
         ...
         i.putExtra("sms_body", String.format("%s %s - Sent from Tag Master",
               this.getTag().getTitle(), this.getTag().getTagUri()));
         this.startActivity(i);
      }
      ...
      GoogleAnalyticsTracker.getInstance().trackPageView(
            "TagDetailActivity/"
                  + this.getIntent().getIntExtra(
                        TagDetailActivity.TAG_ID_EXTRA, -1));
   }

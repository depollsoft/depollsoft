...
public class PitchPerfectActivity extends TabActivity
{
            ...
            .addTab(
                  this.getTabHost()
                        ...
                        .setIndicator(
                              "Keys",
                              this.getResources().getDrawable(
                                    R.drawable.ic_tab_keys))
                        .setContent(
                              new Intent(this, KeySignatureActivity.class)));
   ...
   protected void onResume()
   {
      ...
      GoogleAnalyticsTracker.getInstance()
            .trackPageView("PitchPerfectActivity");

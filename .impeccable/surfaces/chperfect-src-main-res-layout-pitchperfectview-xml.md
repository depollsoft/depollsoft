...
Memorable moment: pressing a glass cell answers with one crisp detent, ignites the panel's only light, and puts the live note and frequency in the hole; sustained notes breathe. Two-note chords identify their musical interval, a barbershop seventh in any voicing reads BARBERSHOP!, and true multi-touch lets each finger release independently.

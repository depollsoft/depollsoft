#!/usr/bin/env python3
"""Register (or remove) source files in pitchperfect.xcodeproj.
...
New files are placed beside SongEditorView.swift (app) or PitchPerfectSongManagementTests.swift (tests).
...
PROJECT = HERE.parent / "pitchperfect.xcodeproj" / "project.pbxproj"

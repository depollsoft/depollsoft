...
public class ReflectedProperty extends Property<Object>
{
   private static class IndexerPathPart extends PathPart
   {
      ...
      public Object getValue(Object root) throws Exception
      {
         if (this.index != null)
         {
            ...
            try
            {
               if (root instanceof Map
                     && ((Map<?, ?>) root).containsKey(this.index))
               {
         ...
         if (root instanceof Map
               && ((Map<?, ?>) root).containsKey(this.indexString))
   ...
   private static class PropertyPathPart extends PathPart
   {
      ...
      public Class<?> getType(Object root) throws Exception
      {
         ...
         Pair<Class<?>, String> id = new Pair<Class<?>, String>(
               root.getClass(), getterName);
         Method getter;
      ...
      public void setValue(Object root, Object value) throws Exception
      {
         ...
         Pair<Class<?>, String> setterId = new Pair<Class<?>, String>(
               root.getClass(), setterName);
         ...
         else
         {
            ...
            {
               String getterName = "get" + this.propertyName;
               Pair<Class<?>, String> getterId = new Pair<Class<?>, String>(
                     root.getClass(), getterName);
               Method getter;
               ...
               setter = ReflectedProperty.getMethod(root.getClass(),
                     setterName, 1, getter.getReturnType());
            }
            catch (Exception e)
            {
            }
   ...
   private static Method getMethod(Class<?> type, String name,
         int parameterCount, Class<?>... hints) throws NoSuchMethodException,
         SecurityException
   {
      for (Method m : type.getMethods())
      {
               ...
               && m.getParameterTypes().length == parameterCount)
         {
            ...
            {
               if (hints[x] != null
                     && !m.getParameterTypes()[x].equals(hints[x]))
               {
                  matches = false;
                  break;
               }
      ...
      throw new NoSuchMethodException("Cannot find a method called " + name
            + " on type " + type + " with " + parameterCount + " parameters.");
   }
   ...
   public ReflectedProperty(Object source, String path)
   {
      ...
      this.getter = new Function<Object>()
      {
         ...
         {
            Object current = ReflectedProperty.this.source;

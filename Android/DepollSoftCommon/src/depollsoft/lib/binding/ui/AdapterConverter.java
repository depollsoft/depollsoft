...
import depollsoft.lib.ui.BoundCollectionAdapter;
...
public class AdapterConverter extends ValueConverter {
  ...
  public Object convertToTarget(Object sourceValue, Class<?> targetType) {
    ...
    return new BoundCollectionAdapter<Object>(source, this.getViewType(),
        this.recycleViews, this.cacheViews, this.getDropDownViewType());
  }

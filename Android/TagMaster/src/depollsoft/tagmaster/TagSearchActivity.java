...
public class TagSearchActivity extends Activity
{
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      UiBinder.bind(
            ...
            new EditTextTextProperty((EditText) this
                  .findViewById(R.id.searchTextBox)), "Model.Query",
            BindingMode.TwoWay);

      ((EditText) this.findViewById(R.id.searchTextBox))
      ...
      this.findViewById(R.id.searchButton).setOnClickListener(
            new OnClickListener()
            {
      ...
      Spinner sheetMusicSpinner = (Spinner) this
      ...
      Spinner learningTracksSpinner = (Spinner) this
      ...
      learningTracksSpinner
            .setOnItemSelectedListener(new OnItemSelectedListener()
            {
                     ...
                     int arg2, long arg3)
               {
                  String selectedValue = (String) arg0.getSelectedItem();
                  if (selectedValue.equals("Not important"))
                     TagSearchActivity.this.getModel().setHasLearningTracks(
                           null);
                  else if (selectedValue.equals("Yes"))
                     TagSearchActivity.this.getModel().setHasLearningTracks(
                           true);
      ...
      partsSpinner.setOnItemSelectedListener(new OnItemSelectedListener()
      {
               ...
               long arg3)
         {
            ...
            if (selectedValue.equals("Any"))
               ...
               TagSearchActivity.this.getModel().setParts(
      ...
      Spinner tagCollectionSpinner = (Spinner) this
            .findViewById(R.id.tagCollectionSpinner);
            ...
            .setOnItemSelectedListener(new OnItemSelectedListener()
            {
                     ...
                     int arg2, long arg3)
               {
                  ...
                  if (selectedValue.equals("Any"))
                     ...
                     TagSearchActivity.this.getModel().setCollection(
                           TagCollection.ClassicTags);
                  else
                     TagSearchActivity.this.getModel().setCollection(
                           TagCollection.EasyTags);
               }
      ...
      sortyBySpinner.setOnItemSelectedListener(new OnItemSelectedListener()
      {
               ...
               long arg3)
         {
            ...
            if (selectedValue.equals("Title"))
               TagSearchActivity.this.getModel()
                     .setSortBy(TagSortOptions.Title);
            else if (selectedValue.equals("Downloads"))
               TagSearchActivity.this.getModel().setSortBy(
   ...
   private void search()
   {
      Intent searchResultsIntent = new Intent(TagSearchActivity.this,
            TagSearchResultsActivity.class);
      searchResultsIntent.putExtra(TagQueryActivity.QUERY_MODEL, JsonSerializer
            .serialize(TagSearchActivity.this.getModel()).toString());

...
public class KeySignatureActivity extends Activity
{
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      UiBinder.bind(this, R.id.majorKeySignatureListView, "Adapter",
      ...
      UiBinder.bind(this, R.id.minorKeySignatureListView, "Adapter",
                  ...
                  if (KeySignatureActivity.this.getModel().getIsMajor())
                     ...
                     KeySignatureActivity.this.minorView
                           .setSelection(KeySignatureActivity.this.majorView
                                 .getFirstVisiblePosition());
                  for (Key k : KeySignatureActivity.this.getModel()
                        .getMajorKeys())
                     k.getNote().stop();
                  for (Key k : KeySignatureActivity.this.getModel()
                        .getMinorKeys())
   ...
   protected void onResume()
   {
      ...
      GoogleAnalyticsTracker.getInstance()
            .trackPageView("KeySignatureActivity");
   }

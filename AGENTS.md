...
- If you use `MATCH_GIT_BASIC_AUTHORIZATION`, set `MATCH_GIT_URL` to an `https://...` Git URL that the GitHub Actions runner can clone. Basic authorization does not apply to `git@github.com:...` SSH URLs.

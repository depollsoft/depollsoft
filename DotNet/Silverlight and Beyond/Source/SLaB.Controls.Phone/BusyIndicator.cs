...
namespace SLaB.Controls.Phone
{
    internal class VisualStates
    {
        ...
        internal const string GroupBusyStatus = "BusyStatus";
        internal const string GroupVisibility = "Visibility";
        internal const string StateBusy = "Busy";
        internal const string StateHidden = "Hidden";
        internal const string StateIdle = "Idle";
        internal const string StateVisible = "Visible";
    }
    /// <summary>

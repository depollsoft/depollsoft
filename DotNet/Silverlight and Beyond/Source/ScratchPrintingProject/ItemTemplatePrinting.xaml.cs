...
namespace ScratchPrintingProject
{
    ...
    public partial class ItemTemplatePrinting : Page
    {
        private readonly People _People;
        public ItemTemplatePrinting()
        {
            InitializeComponent();
        ...
        public static readonly DependencyProperty ItemCountProperty =
            DependencyProperty.Register("ItemCount", typeof(double), typeof(ItemTemplatePrinting), new PropertyMetadata(default(double), OnItemCountChanged));

        private static void OnItemCountChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ((ItemTemplatePrinting)obj).OnItemCountChanged((double)args.OldValue, (double)args.NewValue);
        }
        ...
        public static readonly DependencyProperty ItemsToPrintProperty =
            DependencyProperty.Register("ItemsToPrint", typeof(IEnumerable), typeof(ItemTemplatePrinting), new PropertyMetadata(default(IEnumerable), OnItemsToPrintChanged));

        private static void OnItemsToPrintChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ((ItemTemplatePrinting)obj).OnItemsToPrintChanged((IEnumerable)args.OldValue, (IEnumerable)args.NewValue);
        }

...
namespace SLaB.Utilities.Xaml.Serializer
{
    ...
    public class XamlSerializer
    {
        ...
        protected static Func<object, object> GetPropertyGetter(PropertyInfo inf)
        {
            ...
            var cast = Expression.Convert(param, inf.DeclaringType);
            var getValue = Expression.Property(cast, inf);
            var finalCast = Expression.Convert(getValue, typeof(object));
        ...
        #region Fields (1) 
            ...
            private static readonly Type[] SupportedTypes = new[] { typeof(int), typeof(double), typeof(bool), typeof(string), typeof(Uri) };
